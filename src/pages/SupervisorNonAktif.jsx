...
const SupervisorNonAktif = () => {
  ...
  const getData = async () => {
    try {
      ...
      const supervisorProduksi = getUsers.data
        .filter(
          (user) =>
            user.role === "SUPERVISOR_PRODUKSI" && user.isActive === false
        )
  ...
  const handleRestore = async (id) => {
    try {
      ...
      toast.success("Supervisor berhasil restore", {
        position: "top-right",
  ...
  return (
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-3 max-w-xl">
                Kelola data Supervisor yang sudah dinonaktifkan
              </p>
            </div>
    ...
    "
              ...
              <button
                onClick={() => navigate("/pengguna/supervisor-produksi")}
                className="
    h-11 px-5
    w-full sm:w-auto
...
export default SupervisorNonAktif;
