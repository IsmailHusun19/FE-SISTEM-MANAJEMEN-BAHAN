...
const EditSupervsior = () => {
  ...
  const fetchDetail = async () => {
    try {
      ...
      toast.error("Gagal mengambil data supervsior", {
        position: "top-right",
        description:
      ...
      navigate("/pengguna/edit-supervsior");
    } finally {
      setLoading(false);
    }
  };
  ...
  const updateData = async () => {
    try {
      ...
      if (res.status === 200) {
        toast.success("Supervsior berhasil diperbarui", {
          position: "top-right",
        ...
        navigate("/pengguna/supervisor-produksi");
      }
    } catch (error) {
      toast.error("Gagal memperbarui supervsior", {
        position: "top-right",
        description:
          error?.response?.data?.message ||
          "Terjadi kesalahan sistem",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <h1 className="mt-4 text-[34px] sm:text-[48px] leading-none font-black tracking-tight text-slate-900">
                  Edit <span className="text-orange-500">Supervsior</span>
                </h1>

                <p className="mt-4 text-sm sm:text-base text-slate-500 max-w-2xl leading-relaxed">
                Perbarui informasi supervisor produksi untuk memastikan data pengelolaan tetap akurat dan terbaru.
                </p>
              </div>
            ...
            <div className="p-5 sm:p-8 lg:p-10">
              <div className="mb-8">
                <h2 className="text-xl font-bold text-slate-800">
                  Informasi Supervsior
                </h2>

                <p className="text-sm text-slate-400 mt-1">
                  Lengkapi detail Supervsior dengan benar sebelum menyimpan data.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="lg:col-span-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      placeholder="Example : supervisor@gmail.com@"
                      className="
                        w-full h-13
                        rounded-2xl
                        border border-slate-200
