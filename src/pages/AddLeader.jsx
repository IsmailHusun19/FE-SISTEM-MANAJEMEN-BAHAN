...
const AddLeader = () => {
  ...
  const addData = async (payload) => {
    try {
      ...
      if (res.status === 201) {
        toast.success("leader produksi berhasil ditambahkan", {
          position: "top-right",
      ...
      toast.error("Gagal menambahkan leader-produksi", {
        position: "top-right",
        description: message,
        className: `
          !rounded-2xl
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <h1 className="mt-4 text-[34px] sm:text-[48px] leading-none font-black tracking-tight text-slate-900">
                  Tambah <span className="text-orange-500">Leader Produksi</span>
                </h1>
  
                <p className="mt-4 text-sm sm:text-base text-slate-500 max-w-2xl leading-relaxed">
                Tambahkan data leader produksi baru untuk mendukung proses pengawasan, koordinasi, dan operasional produksi secara lebih terstruktur dan efisien.
                </p>
              </div>
