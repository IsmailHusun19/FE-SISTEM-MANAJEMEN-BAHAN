...
const Gudang = () => {
  ...
  const getData = async () => {
    try {
      ...
      console.error("Gagal mengambil data staff gudang :", error);
      setGudang([]);
    }
  };
  ...
  const handleAdd = () => {
    navigate("/pengguna/tambah-gudang");
  };
  const handleEdit = (id) => {
    navigate(`/pengguna/edit-gudang/${id}`);
  };
        ...
        >
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-6">
            ...
            >
              ...
              <div>
                ...
                <h1 className="text-[30px] sm:text-[42px] leading-none font-bold text-slate-900 mt-2">
                  Data <span className="text-orange-500">Staff Gudang</span>
                </h1>

                <p className="text-slate-500 text-sm mt-3 max-w-xl">
                Kelola data staff gudang produksi yang bertanggung jawab dalam pengelolaan, penyimpanan, dan operasional barang di gudang.
                </p>
              </div>
            ...
            <div className="w-full flex justify-end mt-4 lg:mt-0">
              <button
                onClick={() => navigate("/pengguna/gudang-nonaktif")}
                className="
    h-11 px-5
    rounded-2xl
    mb-4
