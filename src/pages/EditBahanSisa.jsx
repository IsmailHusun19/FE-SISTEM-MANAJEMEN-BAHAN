...
const EditBahanSisa = () => {
  ...
  const getDetail = async () => {
    try {
      ...
      const res = await GetDetailPemakaianBahan(id);

      setForm({
        catatan: res.data.catatan || "",

        bahan:
          res.data.detailBahanSisa?.map((item) => ({
            bahanId: item.bahanId,
            jumlahDipakai: item.jumlahDipakai,
            jumlahSisa: item.jumlahSisa,
          })) || [],
      });
    } catch (error) {
      console.log(error);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await EditPemakaianBahan(id, payload);

      if (res.status === 200) {
        toast.success("Pemakaian bahan berhasil diperbarui", {
          position: "top-right",

          description: "Data berhasil diperbarui ke sistem",
        ...
        navigate(`/detail-pemakaian-bahan/${id}`);
      }
    } catch (error) {
      const message =
      ...
      toast.error("Gagal memperbarui pemakaian bahan", {
        position: "top-right",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <p className="mt-4 text-sm sm:text-base text-slate-500 max-w-2xl leading-relaxed">
                  Perbarui data pemakaian bahan produksi untuk memastikan
                  pencatatan penggunaan bahan tetap akurat dan terstruktur.
                </p>
              </div>
            ...
            <div className="p-5 sm:p-8 lg:p-10">
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Perbarui data pemakaian bahan sebelum menyimpan perubahan.
                </p>
              </div>
