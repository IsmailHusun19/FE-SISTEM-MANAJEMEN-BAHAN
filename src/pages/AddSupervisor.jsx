            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <h1 className="mt-4 text-[34px] sm:text-[48px] leading-none font-black tracking-tight text-slate-900">
                  Tambah <span className="text-orange-500">Supervisor</span>
                </h1>
  
                <p className="mt-4 text-sm sm:text-base text-slate-500 max-w-2xl leading-relaxed">
                Tambahkan data supervisor produksi baru untuk mendukung pengelolaan dan pengawasan proses operasional produksi secara lebih terstruktur.
                </p>
              </div>
            ...
            <div className="p-5 sm:p-8 lg:p-10">
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-400 mt-1">
                  Lengkapi detail Supervisor dengan benar sebelum menyimpan data.
                </p>
              </div>
