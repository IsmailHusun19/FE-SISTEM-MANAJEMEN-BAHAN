...
const LeaderNonAktif = () => {
  ...
  const getData = async () => {
    try {
      ...
      const LeaderProduksi = getUsers.data
        .filter(
          (user) =>
            user.role === "LEADER_PRODUKSI" && user.isActive === false
        )
  ...
  const handleRestore = async (id) => {
    try {
      ...
      toast.success("Leader produksi berhasil restore", {
        position: "top-right",
  ...
  return (
          ...
          <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-4">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-3 max-w-xl">
                Kelola data leader produksi yang sudah dinonaktifkan
              </p>
            </div>
    ...
    "
              ...
              <button
                onClick={() => navigate("/pengguna/leader-produksi")}
                className="
    h-11 px-5
    w-full sm:w-auto
