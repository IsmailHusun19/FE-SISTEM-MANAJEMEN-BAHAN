...
const EditGudang = () => {
  ...
  const fetchDetail = async () => {
    try {
      ...
      toast.error("Gagal mengambil data staff gudang", {
        position: "top-right",
        description:
  ...
  const updateData = async () => {
    try {
      ...
      if (res.status === 200) {
        toast.success("Staff gudang berhasil diperbarui", {
          position: "top-right",
      ...
      toast.error("Gagal memperbarui staff gudang", {
        position: "top-right",
        description:
          error?.response?.data?.message ||
          "Terjadi kesalahan sistem",
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <h1 className="mt-4 text-[34px] sm:text-[48px] leading-none font-black tracking-tight text-slate-900">
                  Edit <span className="text-orange-500">Staff Gudang</span>
                </h1>

                <p className="mt-4 text-sm sm:text-base text-slate-500 max-w-2xl leading-relaxed">
                Perbarui informasi staff gudang untuk memastikan data pengelolaan dan operasional gudang tetap akurat dan terbaru.
                </p>
              </div>
